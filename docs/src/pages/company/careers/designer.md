...
- [MUI X](/x): as mentioned, a growing set of advanced components.
  Today, the flagship is the [Data Grid](/components/data-grid/), a game-changing component for presenting large amounts data, which integrates perfectly with MUI Core.
...
Given that each product is at a different stage, at this moment we believe that one person is enought to oversee the design function for both teams.
...
- Help refine the MUI X documentation, from visual design to copywriting.
